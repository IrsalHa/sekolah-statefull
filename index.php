...
if(isset($_GET['s'])){
  ...
  $key = $konek->real_escape_string($_GET['s']);
  $index = mysqli_query($konek, "SELECT * FROM user WHERE nama LIKE '%$key%' OR email LIKE '%$key%'");
  if(mysqli_num_rows($index) < 1) {
    $index = "null";
  }
}else{
        ...
        <div class="row">
            <div class="col-lg-12">
               ...
               <div class="card card-block card-stretch card-height note-table">
                  ...
                  <input name="s" type="text" class="form-control" placeholder="Cari user" aria-label="Recipient's username" aria-describedby="basic-addon2">
  <div class="input-group-append">
    <button class="btn" style="background: #1f1c2f;color: white;"type="submit">Search</button>
  </div>
                 ...
                 <?php if($index == 'null'){echo '<td class="text-center" colspan="5">Data tidak ada</td>';}else{?>
            ...
            <td>
            <a href="./functions/delete.php?delete=<?php echo $data['id'] ?>" class="btn btn-sm"><span class="material-icons text-dark">delete_forever</span></a>
            <a href="./edit.php?id=<?php echo $data['id']?>" class="btn btn-sm"><span class="material-icons text-dark">edit</span></a>
            </td>
                              </tr>
                              <?php } }?>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 text-right">
                    <span class="text-secondary mr-1"><script>document.write(new Date().getFullYear())</script>©</span> <a href="#" class="">Irsal</a>.
                </div>
            </div>
        </div>
    </footer>
